            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item"><a class="link-fx" href="{{ route('admin.pemesan.index') }}">Pesanan</a></li>
        ...
        <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <form action="{{ route('admin.pemesan.update',$pemesan->no_pesanan) }}" method="POST">
                        @method('PUT')
                        @csrf
                    <div class="row items-push">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            ...
                            <div class="form-group">
                                <label for="tempekan">Status Pesanan</label>
                                <select class="custom-select" name="status">
                                    <option {{ $pemesan->status == "Menunggu" ? 'selected' : ''}} value="Menunggu">Menunggu</option>
                                    <option {{ $pemesan->status == "Selesai" ? 'selected' : ''}} value="Selesai">Selesai</option>
                                </select>
                            </div>
                        </div>
                    </div>
