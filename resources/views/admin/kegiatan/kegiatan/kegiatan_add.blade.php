            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Tambah Kegiatan</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row items-push">
                        <div class="col-lg-6 col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="js-flatpickr form-control bg-white" id="tgl_kegiatan" name="tgl_kegiatan" placeholder="Contoh: 09-04-2021" data-id=minDateToday data-date-format="Y-m-d">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="one-profile-edit-avatar">Input file tambahan disini...</label>
