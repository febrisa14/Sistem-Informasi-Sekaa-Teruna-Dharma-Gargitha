    ...
    <div class="content content-boxed">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <form action="{{route('user.change_foto')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{route('user.delete_foto')}}" data-toggle="click-ripple" class="btn btn-alt-danger">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="form-group">
                                ...
                                @if ($users->email_verified_at == '')
                                    <small class="form-text text-danger"><i class="si si-close mr-1"></i>Email Belum Diverifikasi</small>
                                @else
                            ...
                            {{-- <div class="form-group">
                                ...
                                <select class="custom-select" id="tempekan" name="tempekan">
                                    <option {{ $users->tempekan == "Kauh" ? 'selected' : ''}} value="Kauh">Kauh</option>
                                    <option {{ $users->tempekan == "Kubu" ? 'selected' : ''}} value="Kubu">Kubu</option>
                                    <option {{ $users->tempekan == "Kangin" ? 'selected' : ''}} value="Kangin">Kangin</option>
                                </select>
                            </div> --}}
                            <div class="form-group">
                                <button type="submit" data-toggle="click-ripple" class="btn btn-alt-primary">
